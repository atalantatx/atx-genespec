...
train = pd.DataFrame(gene_data.sample(frac = 0.5))
...
optimize = pd.DataFrame(non_train.sample(frac = 0.5))
...
study = optuna.create_study(direction='minimize', study_name=sel_target, sampler=sampler)
